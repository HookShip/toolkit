...
import type { PostgresPayloadCleanupRepository } from "./postgres-payload-cleanup-repository.js";
import type { PostgresPayloadNamespaceRepository } from "./postgres-payload-namespace-repository.js";
import type { PostgresPayloadReferenceRepository } from "./postgres-payload-reference-repository.js";

export class PostgresPayloadRepository implements PayloadRepository {
  readonly #reference: PostgresPayloadReferenceRepository;
  readonly #cleanup: PostgresPayloadCleanupRepository;
  readonly #namespace: PostgresPayloadNamespaceRepository;

  constructor(
    reference: PostgresPayloadReferenceRepository,
    cleanup: PostgresPayloadCleanupRepository,
    namespace: PostgresPayloadNamespaceRepository,
  ) {
