...
export function assessmentInputDiagnostics(
...
export function sortedIssues(
  items: readonly AssessmentIssue[],
): AssessmentIssue[] {
...
export function mappingPlan(input: AssessmentInput): {
...
export function capabilityParity(input: AssessmentInput): {
...
export function securityGaps(input: AssessmentInput): {
  readonly blockers: AssessmentIssue[];
...
export function operationalGaps(input: AssessmentInput): AssessmentIssue[] {
  const gaps: AssessmentIssue[] = [];
...
export function policyLimitIssues(input: AssessmentInput): AssessmentIssue[] {
  const issues: AssessmentIssue[] = [];
...
export function rollbackPrerequisites(
  input: AssessmentInput,
): RollbackPrerequisite[] {
...
export const migrationPhases: readonly MigrationPhase[] = Object.freeze([
  {
    id: "discover",
