...
export const allowlist = new Map([
  ...
  ["packages/cli/src/commands.ts", 1840],
  ["packages/cli/src/learning-commands.ts", 1994],
  ["packages/cli/src/reference-server/memory-repository.ts", 1786],
  ["packages/cli/src/reference-server/migrations.ts", 1385],
  ["packages/cli/src/reference-server/payload-storage.ts", 1827],
  ["packages/cli/src/reference-server/postgres-repository.ts", 2504],
  ["packages/cli/src/reference-server/server.ts", 2332],
  ["packages/cli/src/reference-server/service.ts", 2175],
  ["packages/contract-core/src/diff.ts", 1720],
  ["packages/contract-core/src/fixtures.ts", 1030],
  ["packages/contract-core/src/normalize.ts", 2313],
