...
BEGIN
  IF NOT EXISTS (
    ...
    SELECT 1
    FROM reference_schema_migrations
    WHERE version = '010_payload_store_identity'
  ) OR EXISTS (
    SELECT 1
    FROM reference_schema_migrations
    ...
    WHERE
      ...
      OR
      (version = '011_store_derived_bucket' AND checksum IS DISTINCT FROM
        '4e1bdd74d436a91381706e63b4fc7dad9158c518773c77a5d392daa29f54e744')
  ) THEN
